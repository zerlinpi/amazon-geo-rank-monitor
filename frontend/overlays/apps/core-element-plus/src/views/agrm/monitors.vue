      ...
      <el-table :data="monitors" empty-text="No monitors yet">
        ...
        <el-table-column label="Actions" width="260" fixed="right">
          <template #default="{ row }">
            ...
            <el-button size="small" @click="toggleEnabled(row)">{{ row.enabled ? 'Disable' : 'Enable' }}</el-button>
            <el-button size="small" type="danger" text @click="remove(row)">Delete</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-card>
